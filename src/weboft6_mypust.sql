...
--
-- Host: localhost:3306
-- Generation Time: Apr 30, 2018 at 11:52 AM
...
--
-- Table structure for table `book_donate`
--
...
CREATE TABLE `book_donate` (
  ...
  `book_standard` varchar(200) NOT NULL,
...
--
-- Dumping data for table `book_donate`
--

INSERT INTO `book_donate` (`id`, `user_id`, `name`, `address`, `book_subject`, `book_language`, `book_standard`, `book_name`, `book_author`, `date`, `Status`) VALUES
(1, '', 'Ankit', 'bangur kolkata', 'Jeans', 'Jeans', '', 'gg', 'iopop', '2018-04-22 08:11:32', 'Pending'),
(2, '', 'Ankit', 'bangur kolkata', 'Jeans', 'Jeans', '', 'gg', 'iopop', '2018-04-22 08:26:58', 'Pending'),
(3, '', 'Ankit', 'bangur kolkata', 'History', 'English', 'Standard I', 'sd', 'sds', '2018-04-22 08:46:03', 'Pending'),
(4, 'UR5ae6cfc7dfa53', '', '', 'Grammar', 'English', 'Standard I', 'rahul', 'aaa', '2018-04-30 08:22:01', 'Pending'),
(5, 'UR5ae6cfc7dfa53', 'Rahul', 'Kolkata', 'Literature', 'English', 'Standard I', 'kj', 'k', '2018-04-30 08:32:52', 'Pending'),
(6, 'UR5ae6df6761332', 'SUMIT KUMAR', 'kestopur', 'Science', '', 'Standard II', 'ncert', 'sumit', '2018-04-30 09:19:18', 'Pending'),
(7, 'UR5ae6df6761332', 'SUMIT KUMAR', 'kestopur', 'Literature', 'English', 'Standard II', 'vjhk', 'bmjk', '2018-04-30 09:32:36', 'Pending'),
(8, 'UR5ae6e9777dd2d', 'Senjuti', 'ad-357 kestopur', 'Grammar', 'English', 'Standard III', 'djgjvh', 'agfhj', '2018-04-30 10:02:29', 'Pending'),
(9, 'UR5ae6df6761332', 'SUMIT KUMAR', 'kestopur', 'Science', 'Bengali', 'Standard I', 'nkjn', 'nkj', '2018-04-30 13:46:23', 'Pending'),
(10, 'UR5ae7236694c4e', 'Shamik', 'Salt Lake', 'Science', 'English', 'Standard II', 'Wren & Martin', 'S.Chand', '2018-04-30 14:09:18', 'Pending');
...
--
-- Table structure for table `cloth_donate`
--

CREATE TABLE `cloth_donate` (
  `user_id` varchar(200) NOT NULL,
  `name` varchar(200) NOT NULL,
  `address` varchar(200) NOT NULL,
  `cloth_category` varchar(200) NOT NULL,
  `cloth_quantity` varchar(200) NOT NULL,
  `cloth_description` varchar(200) NOT NULL,
  `date` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Dumping data for table `cloth_donate`
--

INSERT INTO `cloth_donate` (`user_id`, `name`, `address`, `cloth_category`, `cloth_quantity`, `cloth_description`, `date`, `delivery`, `id`, `Status`) VALUES
('', 'John', 'Doe', 'Jeans', '', 'mm', '2018-04-22 07:19:36', 'Manual', 1, 'Pending'),
('', '', '', 'Shirt', '8', 'dsd', '2018-04-22 07:29:37', 'Autmoated', 2, 'Pending'),
('', 'Ankit', 'bangur kolkata', 'Shirt', '8', 'dsd', '2018-04-22 07:31:00', 'Autmoated', 3, 'Pending'),
('UR5ae6cfc7dfa53', 'Rahul', 'Kolkata', 'Jeans', '7', 'mn', '2018-04-30 08:31:03', 'Automated', 4, 'Accepted'),
('UR5ae6df6761332', 'SUMIT KUMAR', 'kestopur', 'Shirt', '9', 'rtghhghj', '2018-04-30 09:21:03', 'Automated', 5, 'Pending'),
('UR5ae6df6761332', 'SUMIT KUMAR', 'kestopur', 'Shirt', '7', 'ssgfhgh', '2018-04-30 09:27:51', 'Automated', 6, 'Pending'),
('UR5ae6ec70662da', 'Dannie', 'Rio De Janeiro', 'Jeans', '4', '', '2018-04-30 10:14:32', 'Manual', 7, 'Pending'),
('UR5ae6e9777dd2d', 'Senjuti', 'ad-357 kestopur', 'Jeans', '6', '', '2018-04-30 14:03:17', 'Automated', 8, 'Pending'),
('UR5ae72204c1815', 'tithi', 'khardah', 'Shirt', '5', '', '2018-04-30 14:04:05', 'Automated', 9, 'Pending');
...
INSERT INTO `donation` (`donate_id`, `user_id`, `donar_name`, `donar_email`, `city_id`, `address`, `category_id`, `date`, `discription`, `pickup`, `receive_date`) VALUES
('DN57fe28a2b976d', NULL, 'adasd', 'asdas@adas', 312, '				asdasd', 'CT7hjkb6h8j65gv', '2016-10-12', '				asdasdasd', 'M', NULL),
('DN57fe428e15dbe', NULL, 'sadasd', 'asdsad@fsda', 404, '	asdasdasd			', 'CT7hjkb6h8j65gv', '2016-10-12', '			asdasd	', 'A', NULL);
...
INSERT INTO `user` (`user_id`, `name`, `address`, `phno`, `state`, `city`, `email`, `password`, `admin`) VALUES
('UR5ae6cfc7dfa53', 'Rahul', 'Kolkata', 99, 'West Bengal', 'Kolkata', 'choudharyrahul8444@gmail.com', 'd8578edf8458ce06fbc5bb76a58c5ca4', '1'),
('UR5ae6df6761332', 'SUMIT KUMAR', 'kestopur', 2147483647, 'West Bengal', 'Kolkata', 'smt.ranjan1@gmail.com', '72610cad9024ccf6374d42c9cf5fc669', '0'),
('UR5ae6e9777dd2d', 'Senjuti', 'ad-357 kestopur', 2147483647, 'West Bengal', 'Kolkata', 'senjuti@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '0'),
('UR5ae6ec70662da', 'Dannie', 'Rio De Janeiro', 2147483647, 'West Bengal', 'Kolkata', 'daniel1234@gmail.com', 'f2dd818b8b0252b5e1b69b608934b0f0', '0'),
('UR5ae72148ac5ab', 'Ranita  Saha', 'old baharampor, Shyama Prasad pally,Opposit of Bra', 2147483647, 'West Bengal', 'Kolkata', 'ranitasaha690@gmail.com', '196a157f77ec3bd16db2030f22e42c80', '0'),
('UR5ae72204c1815', 'tithi', 'khardah', 78945, 'West Bengal', 'Kolkata', 'tc@gmail.com', '202cb962ac59075b964b07152d234b70', '0'),
('UR5ae7236694c4e', 'Shamik', 'Salt Lake', 2147483647, 'West Bengal', 'Kolkata', 'shamikkundu13@gmail.com', 'f2dd818b8b0252b5e1b69b608934b0f0', '0');
...
CREATE TABLE `user_data` (
  ...
  `admin` int(200) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user_data` (`user_id`, `first_name`, `middle_name`, `last_name`, `gender`, `date_of_birth`, `address`, `city_Id`, `mobile`, `email`, `password`, `security_que`, `answer`, `profile_pic`, `admin`) VALUES
('UR57f6ab39d0d8b', 'Ankit', NULL, NULL, NULL, NULL, 'bangur kolkata', NULL, NULL, 'thakurat44@gmail.com', 'f3caf022fc58b49f8520d62525e0cb6c', 'Who are you?', 'ankit', NULL, 1),
('UR57f6b3ba0b868', 'Hardik', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'hardikparekhhp@gmail.com', '6fb42da0e32e07b61c9f0251fe627a9c', NULL, NULL, NULL, 0);
...
--
-- Indexes for table `book_donate`
--
ALTER TABLE `book_donate`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cloth_donate`
--
ALTER TABLE `cloth_donate`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- AUTO_INCREMENT for table `book_donate`
--
ALTER TABLE `book_donate`
  MODIFY `id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `cloth_donate`
--
ALTER TABLE `cloth_donate`
